...
def ZeroProfit(x):
    ...
    P=[power,energy,effi,network.stores.e_nom_opt.values, network.links.loc['Charge'].p_nom_opt,network.links.loc['Discharge'].p_nom_opt*dischargeeffi,fuel_cost,g,s,w,st,c,ww,ss,chargeeffi,dischargeeffi]

    df=pd.DataFrame([P],columns=['power','energy','effi','storage','charge','discharge','fuel_cost','Gasuse','solar','wind','discharge','charge','Wind','Solar','chargeeffi','dischargeeffi'])
...
B1=    df=pd.DataFrame([P],columns=['power','energy','effi','storage','charge','discharge','fuel_cost','Gasuse','solar','wind','discharge','charge','Wind','Solar','chargeeffi','dischargeeffi'])
effi=0.6
for fuel_price in [100]:   
    for rat in [1,1.2,1.4,1.6,2,4,8]:
