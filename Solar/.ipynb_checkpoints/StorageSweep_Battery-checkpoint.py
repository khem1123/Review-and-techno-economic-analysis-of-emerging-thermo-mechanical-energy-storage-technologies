...
def ZeroProfit(x):
    ...
    network.add("Store",
          ...
          capital_cost = annuity(13, 0.07)*energy)
    ...
    network.add("Link",
          ...
          capital_cost =  annuity(13, 0.07)*power*factorc+powerOM*factorc)
    ...
    network.add("Link",
          ...
          capital_cost = annuity(13, 0.07)*dischargeeffi*power*(1-factorc)+powerOM*(1-factorc))
...
for fuel_price in [60,100,140]: 
    for effi in [0.85,0.9,0.95]:
        for energy in [30000,50000,100000,150000,200000,250000,300000]:
            A=100
            cc=50000
            while A>20:
                cc=cc+200000
...
B1.to_csv('Battery_Storage.csv',index=False)