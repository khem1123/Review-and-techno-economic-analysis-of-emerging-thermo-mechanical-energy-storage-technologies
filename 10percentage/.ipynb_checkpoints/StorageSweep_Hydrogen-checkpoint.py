...
def ZeroProfit(x):
    ...
    network.add("Store",
          ...
          capital_cost = annuity(18, 0.07)*energy)
    ...
    network.add("Link",
          ...
          capital_cost =  annuity(18, 0.07)*power*factorc+powerOM*factorc)
    ...
    network.add("Link",
          ...
          capital_cost = annuity(18, 0.07)*dischargeeffi*power*(1-factorc)+powerOM*(1-factorc))
...
B1.to_csv('Hydrogen_Storage.csv',index=False)