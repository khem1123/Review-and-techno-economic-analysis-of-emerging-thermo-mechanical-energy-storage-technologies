...
def annuity(n,r):
    ...
    # This function has the pypsa Set up!!! 
...
def ZeroProfit(x):
    ...
    factorc=0.097  # I have total capital cost for Power I use this to seperate charging & discharging costs
...
for fuel_price in [60,100,140]:  
    for effi in [0.38,0.42,0.47]:
        for energy in [5000,10000,20000,30000,40000,50000]:
            A=100
            cc=300000  # Start value for Capital cost ! 
            while A>10:
                cc=cc+200000
