...
while Discharge>10:
    ...
    network.add("Link",
          ...
          capital_cost =  annuity(25, 0.07)*power*factorc+powerOM*factorc/30)
    ...
    network.add("Link",
          ...
          capital_cost = annuity(25, 0.07)*dischargeeffi*power*(1-factorc)+powerOM*(1-factorc)/30)
...
B1.to_csv('LiquidAir_Fuel.csv',index=False)